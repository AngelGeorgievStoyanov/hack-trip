            ...
            <Grid container sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', bgcolor: '#cfe8fc', padding: '0', margin: '-25px 0px 0px 0px', minHeight: '100vh' }} spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', bgcolor: '#cfe8fc', maxWidth: '80%' }}>
                    ...
                    <CardMedia
                        ...
                        loading="lazy"
                    />
                    <h4 style={{ margin: '2px', fontFamily: 'cursive' }}> It's integrated for you Google Maps and you can add points Markers.</h4>
                    ...
                    <CardMedia
                        ...
                        loading="lazy"
                    />
                    <h4 style={{ margin: '2px', fontFamily: 'cursive' }}> As you can mark everything you want, a city, hotel, restaurant, shop,
                    ...
                    <CardMedia
                        ...
                        loading="lazy"
                    />
                    <h4 style={{ margin: '2px', fontFamily: 'cursive' }}>
